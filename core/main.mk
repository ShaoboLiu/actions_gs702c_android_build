...
# ywwang: ignore wifi & bluetooth modules,they will be compiled batch see leopard/build/gs702c/wifi.mk, bluetooth.mk
additional_prune_dir += --prune=device/actions/hardware/wifi --prune=device/actions/hardware/bluetooth --prune=hardware/invensense

subdir_makefiles := \
	$(shell build/tools/findleaves.py --prune=$(OUT_DIR) --prune=.repo $(additional_prune_dir) --prune=.git $(subdirs) Android.mk)
